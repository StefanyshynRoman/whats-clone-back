...
import rstefanyshyn.messaging.domain.message.aggregate.MessageBuilder;
...
public class MessageEntity extends AbstractAuditingEntity<Long> {
    ...
    public static MessageEntity from(Message message) {
        ...
        UserEntity user = rstefanyshyn.infrastructure.secondary.entity.UserEntityBuilder.userEntity()
