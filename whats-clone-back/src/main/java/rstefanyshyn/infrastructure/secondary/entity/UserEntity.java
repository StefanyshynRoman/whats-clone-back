...
import rstefanyshyn.messaging.domain.user.aggregate.UserBuilder;
import rstefanyshyn.messaging.domain.user.vo.*;
...
public class UserEntity extends AbstractAuditingEntity<Long> {
    ...
    public static UserEntity from(User user) {
        rstefanyshyn.infrastructure.secondary.entity.UserEntityBuilder userEntityBuilder = rstefanyshyn.infrastructure.secondary.entity.UserEntityBuilder.userEntity();
