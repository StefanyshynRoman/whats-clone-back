...
import rstefanyshyn.messaging.domain.user.aggregate.AuthorityBuilder;
...
public class AuthorityEntity {
    ...
    public static Set<AuthorityEntity> from(Set<Authority> authorities) {
        return authorities
                .stream()
                .map(authority ->
                        rstefanyshyn.infrastructure.secondary.entity.AuthorityEntityBuilder.authorityEntity()
