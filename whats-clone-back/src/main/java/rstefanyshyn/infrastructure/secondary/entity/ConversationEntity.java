package rstefanyshyn.infrastructure.secondary.entity;

import jakarta.persistence.*;
import org.hibernate.annotations.UuidGenerator;
import org.jilt.Builder;
import rstefanyshyn.messaging.domain.message.aggregate.Conversation;
import rstefanyshyn.messaging.domain.message.aggregate.ConversationBuilder;
...
import rstefanyshyn.shared.jpa.AbstractAuditingEntity;
...
public class ConversationEntity extends AbstractAuditingEntity<Long> {
    ...
    public static ConversationEntity from(Conversation conversation) {
        rstefanyshyn.infrastructure.secondary.entity.ConversationEntityBuilder conversationEntityBuilder
                = rstefanyshyn.infrastructure.secondary.entity.ConversationEntityBuilder.conversationEntity();
    ...
    public static ConversationEntity from(ConversationToCreate conversation) {
        rstefanyshyn.infrastructure.secondary.entity.ConversationEntityBuilder conversationEntityBuilder = rstefanyshyn.infrastructure.secondary.entity.ConversationEntityBuilder.conversationEntity();
